    ...
    <div className="flex flex-col gap-8 pb-8 md:gap-16 md:pb-16 xl:pb-24">
      <div className="flex flex-col items-center justify-center max-w-3xl px-8 mx-auto mt-8 sm:min-h-screen sm:mt-0 sm:px-0">
        <div className="hidden sm:mb-8 sm:flex sm:justify-center">
          <Link
            href="https://github.com/Zigmod/EnvShare-Deploy.git"
        ...
        <div>
          ...
          <p className="mt-6 leading-5 text-zinc-600 sm:text-center">
           EnvShare not only encrypt Enviroment Variables, you can also send Messages and Files privately with Share and Unseal tools.
          </p>
      ...
      <h2 className="py-4 text-3xl font-bold text-center text-zinc-300 ">Upstash deployed by Zigmod.</h2>
    </div>
  );
}
